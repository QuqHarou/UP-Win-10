...
Убрана фича, поставить все галочки, для того чтобы вы не отключали сразу все службы а по возможности изучили их, если вы уверены что не пользуетесь visual studio у вас нет второго монитора нет принтера у вас локальная учетная запись вы не пользуетесь локальной сетью (то есть у вас один компьютер), (это малая часть того что я перечислил) то можете отключить службы нажав колесиком мыши по заголовку службы, если все же вам что-то нужно и вы заметили что что-то перестало работать, то откатите службы и проверьте заработала ли та функция которая вам нужна (например вам нужны службы диагностики или счётчики производительности), я понимаю что это не удобно, я над эти работаю, если вам лень изучать службы, то прошу не пользоваться этим функционалом приложения до лучших времен. Всем удачи и всего хорошего!
